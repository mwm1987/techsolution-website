...
// Contact form using your own backend.
// For GitHub Pages, change window.TECHSOLUTIONS_API_URL in index.html or here.
const contactForm = document.getElementById("contactForm");
const formStatus = document.getElementById("formStatus");

const API_BASE_URL = window.TECHSOLUTIONS_API_URL || "http://localhost:3000";
